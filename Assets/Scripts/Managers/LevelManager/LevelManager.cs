...
public class LevelManager : MonoBehaviour
{
    ...
    public IState person_intro, initial_dialogue, make_questions, interview_conclusion, post_interview;// initial_dialogue = new InitialDialogue(this);
    ...
    public Dialogue create_dialogue(DialogueStruc[] text)
    {
        ...
        {
            if ((text[i].character == null) || (text[i].character == Singleton.Instance.interviewed_character))
            {
